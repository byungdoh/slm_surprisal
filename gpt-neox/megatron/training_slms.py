...
from megatron.data.data_utils import build_train_valid_test_data_iterators, build_loaded_iterators
...
def pretrain(neox_args):
    ...
    (
        ...
        valid_data_iterator,
        test_data_iterator,
    ) = build_loaded_iterators(neox_args=neox_args)
...
def train(
    ...
    while iteration < neox_args.train_iters:
        ...
        # manually hacked by OBD for convenience
        if iteration == 10002:
            exit(0)
